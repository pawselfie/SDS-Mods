...
MakeWeapon("Arm Cannon", {ragdoll = 0, projectile = "CrystalRocket", bombJumpMultiplier = 0.65, minDamage = 140, damage = 260, speed = 75, radius = 6.5, detTime = 0.51}, {projectile = "CrystalRocket", projectileSpeed = 75, chargeTime = 999})
...
MakeWeapon("Shadow Bomb", nil, {noPlant = false})
...
MakeWeapon("Tennis Racket", {ragdollResist = true, toolName = "Bridge Trowel", speed = 100, damage = 25, ragdoll = 1.4, knockback = Vector3.new(-40, 0, -40)}, {reloadModifier = 0.1, swingSpeed = 0.3, ragdollResist = true, projectileSpeed = 100})
MakeWeapon("Golden Racket", {ragdollResist = true, toolName = "Bridge Trowel", speed = 100, damage = 25, ragdoll = 1.4, knockback = Vector3.new(-40, 0, -40)}, {reloadModifier = 0.1, swingSpeed = 0.3, ragdollResist = true, projectileSpeed = 100}) --tenis racket skin
MakeWeapon("Ice Sword", {damage = 30, chill = 2.5, speed = 88, ragdollResist = true, toolName = "Bridge Trowel",}, {ragdollResist = true, projectileSpeed = 88, reloadModifier = 0.3333, swingSpeed = 0.3})
...
MakeWeapon("Fire Sword", {ragdollResist = true, toolName = "Bridge Trowel", speed = 88, fireChance = 100}, {ragdollResist = true, projectileSpeed = 88, reloadModifier = 0.3333, swingSpeed = 0.5})
MakeWeapon("Firebrand", {ragdollResist = true, toolName = "Bridge Trowel", speed = 88, fireChance = 100}, {ragdollResist = true, projectileSpeed = 88, reloadModifier = 0.3333, swingSpeed = 0.5}) --fire sword skin
